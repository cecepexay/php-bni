...
<center>
<br><br>
<font style="font-size:28px;">REPORT REGISTER SURAT MASUK </font><br>
<font style="font-size:18px;">BNI DIVISI OTI</font> 
<hr width="80%;">
<div style="padding:30px;">
<form method="post" action="page/laporan_surat_masuk.php">
<table>
	<tr>
	...
	<tr>
		...
		<td>:</td>
		<td>
			<select name="apl_awal" style="width:100px; height:25px;">
			';
				for ($x = 1; $x <= 14; $x++) 
				{
					$aplikasinya  = sprintf("%02s", $x);
					echo '<option value="'.$aplikasinya.'">'.nama_aplikasi($aplikasinya).'</option>';
				} 
			echo '
			</select>
		</td>
	...
	<tr>
		...
		<td>:</td>
		<td>
			<select name="tgl_awal" style="width:100px; height:25px;">
			';
				for ($x = 1; $x <= 31; $x++) 
				{
	...
	<tr>
		...
		<td>:</td>
		<td>
			<select name="tgl_akhir" style="width:100px; height:25px;">
			';
				for ($x = 1; $x <= 31; $x++) 
				{
					$tanggalnya  = sprintf("%02s", $x);
